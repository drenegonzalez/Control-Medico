...
# Ruta base absoluta para Vercel Serverless
...
if DATABASE_URL:
    ...
    # Limpiar parámetros URL incompatibles con pg8000
    if "?" in DATABASE_URL:
        DATABASE_URL = DATABASE_URL.split("?")[0]

    # pg8000 requiere ssl_context explícito para Vercel/Neon Postgres
    ...
    try:
        ...
        if not db.query(UsuarioDB).first():
            usuarios_iniciales = [
                ...
                UsuarioDB(username="doc_perez", email="perez@hospital.com", hashed_password=pwd_context.hash("doc123"), rol=RolUsuario.MEDICO),
                UsuarioDB(username="nutri_gomez", email="gomez@hospital.com", hashed_password=pwd_context.hash("nutri123"), rol=RolUsuario.NUTRICIONISTA),
            ]
