...
def exportar_pacientes_excel(
    ...
    output = io.StringIO()
    writer = csv.writer(output, delimiter=';') # Delimitador ';' recomendado para la configuración regional de Excel en español
    writer.writerow(["ID", "Nombre", "Edad", "Teléfono", "Antecedentes Médicos", "Fecha de Registro"])
    ...
    content = "\ufeff" + output.getvalue() # UTF-8 BOM para reconocimiento automático de tildes/caracteres especiales en Excel
    return Response(
